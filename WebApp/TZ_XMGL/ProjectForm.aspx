<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectForm.aspx.cs" Inherits="Yawei.App.Project.ProjectForm" %>
         ...
         <div class="content" >
            <div id="since" class="leftsidebar" style="vertical-align:top;width:70px;background-color:#eaf2ff;box-shadow:0 0 10px black;text-align:center">
             ...
             <div class="leftsidebar" id="all" style="vertical-align:top;width:250px;display:none;position:relative">
                ...
                <img  src="../images/shared/xtcd.png" style="height:20px;width:25px;vertical-align:text-bottom;margin-left:15px"/>     系统菜单
            <span style="cursor:pointer;display:inline-block;font-size:10px;right:5px;top:7px;position:absolute" > 
                <img src="../images/application_double.png" onclick="classtab(2)" style="position:absolute;right:5px;top:0px;cursor:pointer;width:16px"   /></span>
        </div>
            ...
            <div id="cmenu" style="width:200px;overflow-x:hidden;overflow-y:auto"><ul class="ztree" id="ztree" ></ul></div>
            ...
            <div class="right-content" style="vertical-align:top"  >
               <iframe id="ifmContent" name="Content" style="width:100%;height:100%;display:block;overflow-x:hidden" frameborder="0" src="tz_xmsb/View.aspx?xmguid=<%=Request["Guid"] %>"></iframe>
             </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.fn.zTree.init($("#ztreeall"), setting, menuJson).expandAll(false);
        CreateFirstMenu();
        ...
        $("#ifmContent").attr("src","tz_xmsb/View.aspx?xmguid="+projGuid);
    ...
    function CreateFirstMenu()
    {
        ...
        $.each(menuJson,function(i,dat)
        {
             ...
             htmlMenu+='<div onclick="divonclick(this)"  class="menuDiv"  title="'+dat.name+'">';
