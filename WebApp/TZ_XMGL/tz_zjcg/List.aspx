<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_zjcg.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：直接采购信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
		...
		{ field: "gysmc", name: "供应商名称", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "cgjg", name: "采购价格(万元)", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_zjcg" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
