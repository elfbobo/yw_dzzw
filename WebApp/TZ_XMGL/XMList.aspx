<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMList.aspx.cs" Inherits="WebApp.TZ_XMGL.XMList" %>
        ...
        <div class="easyui-tabs">
            <div title="项目信息">
                <div style="width: 100%; text-align: center">
                    <div class="FormMenu">
                        <div class="MenuLeft">
                            &nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：项目登记信息<label id="sqlwhere" style="display: none" hidden="hidden"></label>
                        </div>
                        <div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.sortName = "StartDate,ProName";
    cfg.order = "desc";
    cfg.pageCount = 12;
    ...
    cfg.columns = [
        ...
        { field: "IsNewStart", name: "是否新开工", width: "20%", align: "left", render: cfg.render }
    ];
    ...
    function ttabs(pg, titile) {
        if ($('.easyui-tabs').tabs('exists', titile)) {
            ...
            $('.easyui-tabs').tabs('add', {
                title: titile,
                content: '<iframe src="ProjectForm.aspx?Guid=' + pg + '" frameborder="0" width="100%"  height="' + (h + 100) + '"></iframe>',
                closable: true
            });
        }
    }
