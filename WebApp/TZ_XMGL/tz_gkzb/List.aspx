<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_gkzb.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：公开招标 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "zbrq", name: "招标日期", align: "left", render: cfg.render, drag: true },
        { field: "zbkzj", name: "招标控制价(万元)", width: "10%", align: "center", render: cfg.render, drag: true },
		{ field: "zbnr", name: "招标内容", width: "10%", align: "center", render: cfg.render, drag: true },
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_gkzb" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
