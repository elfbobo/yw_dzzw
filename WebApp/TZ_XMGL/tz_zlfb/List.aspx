<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_zlfb.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：年度自评 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    <%}else{%>
    cfg.where=" and sysstatus!=-1 and StartDeptGuid='<%=CurrentUser.UserGroup.Guid%>'"
    <%}%>
    cfg.condition = " ";
    ...
    function showreport(psfiles) {
        ...
        cfgPsView.fileSign = "zlfbfj";

        cfgPsView.view = true;
        cfgPsView.title = "自评报告"
