<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_jzxcs.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?ProjGuid=<%=proGuid %>">项目招标</a> >> 竞争性磋商信息
                </div>
                <div class="MenuRight">
            ...
            <table style="width: 100%" class="table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="TdContent" style="width: 35%">
                        <asp:TextBox runat="server" empty="true" ID="zbkzj" double="true"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="zbdw"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td class="TdContent">
                        <asp:TextBox runat="server" ID="ggrq" ReadOnly="true" class="Wdate" empty="true" onfocus="WdatePicker()"></asp:TextBox>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        cfg0.fileSign = "tz_zb_jzxcs_zhaob";
        cfg0.title = "招标文件";
        ...
        cfg1.fileSign = "tz_zb_jzxcs_zhongb";
        cfg1.title = "中标文件";
