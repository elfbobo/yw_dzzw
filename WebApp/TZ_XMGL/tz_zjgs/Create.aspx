<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_zjgs.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?ProjGuid=<%=proGuid %>">资金估算信息</a> >> 编辑资金估算信息
                </div>
                <div class="MenuRight">
            ...
            <table style="width: 100%" class="table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="TdLabel" style="width: 15%">投资估算额(万元)</td>
                    <td class="TdContent" style="width: 35%">
                        <asp:TextBox runat="server" empty="true" ID="tzgse" double="true"></asp:TextBox>
                    </td>
                ...
                <%--<tr>
                    <td class="TdLabel" style="width: 15%">估算明细</td>
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="gsmx"></asp:TextBox>
                    </td>
                </tr>--%>
