<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_xj.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：询价信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "cgmc", name: "采购名称", align: "left", render: cfg.render, drag: true },
        { field: "cgnr", name: "采购内容", width: "10%", align: "center", render: cfg.render, drag: true },
		{ field: "cgkzj", name: "采购控制价(万元)", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "xjd", name: "询价单", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "zbdw", name: "中标单位", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "zbje", name: "中标金额(万元)", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_xj" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
