<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_xj.Create" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; text-align: center">
                ...
                <tr>
                    ...
                    <td class="TdContent">
                        <fieldset style="margin-top: 5px">
                            <legend><span id="file1" style="width: 150px; font-size: 13px; font-weight: bold">上传</span></legend>
            ...
            <fieldset style="margin-top: 5px">
                <legend><span id="file0" style="width: 150px; font-size: 13px; font-weight: bold">附件上传</span></legend>
...
<script type="text/javascript">
    ...
    config.saveData(function () {
        ...
        var cgkzjstr = $("#cgkzj").val();
        if (cgkzjstr.length > 10 || parseInt(cgkzjstr) == 0) {
