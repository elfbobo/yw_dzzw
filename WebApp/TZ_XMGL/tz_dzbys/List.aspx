<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_dzbys.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：电子政务中心验收信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
		...
		{ field: "ryjysnr", name: "软硬件验收内容", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "yzyysnr", name: "云资源验收内容", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
