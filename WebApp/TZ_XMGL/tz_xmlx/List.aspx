<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_xmlx.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：项目立项信息 </div>
		<div class="MenuRight">
			
			<a style="cursor:pointer;display:none" id="search" ><img src="<%=Yawei.Common.AppSupport.AppPath %>/images/img_282.png" style="vertical-align:text-bottom;height:13px;width:13px" />&nbsp;查询</a>
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "lxmc", name: "立项名称", align: "left", render: cfg.render, drag: true },
        { field: "pfwh", name: "批复文号", width: "10%", align: "center", render: cfg.render, drag: true },
		{ field: "pfsj", name: "批复时间", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "pfje", name: "批复金额(万元)", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_xmlx" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
