<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMJS.tz_zjcg.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：自行采购信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
		...
		{ field: "gysmc", name: "供应商名称", width: "30%", align: "center", render: cfg.render, drag: true },
        { field: "htje", name: "合同金额(万元)", width: "20%", align: "left", render: cfg.render, drag: true }
    ];
