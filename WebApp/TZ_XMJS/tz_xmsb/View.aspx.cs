...
namespace WebApp.Project.StartProjectJs
{
    public partial class View : SharedPage
    {
        ...
        {
            string querysql = "select * from tz_projecthistory where proguid='" + strGuid + "' and (proaction='退回' or proaction='申报') order by createdate";
