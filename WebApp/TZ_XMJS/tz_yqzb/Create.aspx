<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMJS.tz_yqzb.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?xmguid=<%=proGuid %>">邀请招标</a> >> 新建招标信息
                </div>
                <div class="MenuRight">
