<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMJS.tz_yqzb.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：邀请招标 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_yqzb" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
