<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMJS.tz_jzxtp.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?ProjGuid=<%=proGuid %>">项目招标</a> >> 竞争性谈判信息
                </div>
                <div class="MenuRight">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        cfg0.fileSign = "tz_zb_jzxtp_zhaob";
        cfg0.title = "招标文件";
        ...
        cfg1.fileSign = "tz_zb_jzxtp_zhongb";
        cfg1.title = "中标文件";
