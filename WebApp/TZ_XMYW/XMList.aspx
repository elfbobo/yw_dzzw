<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMList.aspx.cs" Inherits="WebApp.TZ_XMYW.XMList" %>
        ...
        <div class="easyui-tabs">
            <div title="项目信息">
                <div style="width: 100%; text-align: center">
                    <div class="FormMenu">
                        <div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：项目运维 

                            <span style="width:20px">&nbsp;</span>
                            <span>&emsp;&emsp;&emsp;按&nbsp;</span>
                            <span class="layui-breadcrumb">
                                <a href="List.aspx"><img src="images/001.jpg" /></a>
                                <a ><img src="images/004.jpg" /></a>
                            </span>
                            <span>&nbsp;查看</span>
                        </div>
                        <div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.render = function (value, rowsData, key) {
        ...
        return "<a href='XMView.aspx?xmguid=" + rowsData.ProGuid + "'  style='cursor:pointer;' title='" + value + "' >" + value + "</a>";
    }
    cfg.columns = [
        ...
        { field: "ywcount", name: "运维记录", width: "10%", align: "center", render: cfg.render, drag: true }
    ];
