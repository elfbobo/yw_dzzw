...
namespace WebApp.XM_ZFTZ.Project.StartProject
{
    public partial class View : SharedPage
    {
        ...
        {
            string querysql = "select * from tz_zftz_ProjectHistory where proguid='" + strGuid + "' and (proaction='退回' or proaction='申报' or proaction='暂缓' or proaction='整合') order by createdate";
