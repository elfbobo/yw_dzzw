...
namespace WebApp.XM_ZFTZ.Project.StartProject
{
    public partial class Create : SharedPage
    {
        ...
        protected void ProCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.ProCategory.SelectedValue == "其他")
            {
                this.ProCategoryDesc.Visible = true;
            }
            else
            {
                this.ProCategoryDesc.Visible = false;
            }
        }

        protected void ProProperty_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.ProProperty.SelectedValue == "其他")
            {
                this.ProPropertyDesc.Visible = true;
            }
            else
            {
                this.ProPropertyDesc.Visible = false;
            }
        }
    }
}