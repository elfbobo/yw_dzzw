        ...
        TreeGrid: function (options) {
            ...
            return this.each(function () {
                ...
                if (opt.ajaxUrl == "") {
                    ...
                    GetData(opt.idField, opt.ajaxUrl, opt.sortName, opt.order, opt.connectionName, opt.connectionString, opt.providerName, opt.tableName, opt.condition, opt.pageCount, opt.where, opt.columns, opt.page, opt.parentfield, opt.childfield, opt.childWhere, opt.relevanSearch, opt.childorder);
                    //    $headtable.width($datatable.width());
                    if (opt.Pagination) {
                        pageSize();
                    }
                ...
                //ajax请求数据
                function GetData(idField, ajaxUrl, sort, order, connectionName, connectionString, providerName, tableName, condition, pageCount, where, columns, page, parentfield, childfield, childWhere, relevanSearch, childorder) {
                    $.ajax({
                        type: "POST",
                        url: ajaxUrl,
                        dataType: "json",
                        ...
                        data: { idField: idField, sort: sort, order: order, connectionName: connectionName, connectionString: connectionString, providerName: providerName, tableName: tableName, condition: condition, rows: pageCount, page: page, where: where, parentfield: parentfield, childfield: childfield, childWhere: childWhere, relevanSearch: relevanSearch , childorder: childorder},
                                        ...
                                        if (colDat.checkbox) {
                                            ...
                                            if (colDat.collapsible) {
                                                if (rowDat.children) {
                                                    var span = $("<span />");
                                                    if (!opt.ExpandAll) {
                                                        span.addClass("tree-collapsed");
                                                    }
                                                    else {
                                                        span.addClass("tree-expanded");
                                                    }
                                                    ...
                                                    span.click(function () {
                                                        ...
                                                        if (opt.childrenisload) {
                                                            if (!tr.attr("haved")) {
                                                                tr.after(childrenTableData(tr.data("cdat"), opt.columns, level + 1));
                                                                tr.attr("haved", true);
                                                                //_setGrid();
                                                            }
                                                ...
                                                if (rowDat.children) {
                                                    ...
                                                    span1.click(function () {
                                                        ...
                                                        if ($(this).prev().prev().attr("class") == "tree-collapsed") {
                                                            $(this).prev().prev().addClass("tree-expanded").removeClass("tree-collapsed");
                                                            $(this).prev().prev().next().addClass("tree-folder-open").removeClass("tree-folder");
                                                            tr.next().find("div").eq(0).hide();
                                                            tr.next().show();
                                                            tr.next().find("div").eq(0).slideDown("slow", function () {
                                                                $headtable.width($datatable.width());
                                                        ...
                                                        else if ($(this).prev().prev().attr("class") == "tree-expanded") {
                                                            $(this).prev().prev().addClass("tree-collapsed").removeClass("tree-expanded");
                                                            $(this).prev().prev().next().addClass("tree-folder").removeClass("tree-folder-open");
                                                    ...
                                                    if (colDat.render && typeof (colDat.render) == "function") {
                                                        ...
                                                        td.find("span:last").append("<span class='tree-title'>" + trStr + "</span>");
                                                    }
                                                    else {
                                                        td.find("span:last").append("<span class='tree-title'>" + rowDat[key].replace('0:00:00', '') + "</span>");
                                                    }
                                                }
                                                else {
                                                    if (colDat.render && typeof (colDat.render) == "function") {
                ...
                function gridContent() {
                    GetData(opt.idField, opt.ajaxUrl, arguments[1], arguments[0], opt.connectionName, opt.connectionString, opt.providerName, opt.tableName, opt.condition, opt.pageCount, opt.where, opt.columns, opt.page, opt.parentfield, opt.childfield, opt.childWhere, opt.relevanSearch, opt.childorder);
                    // pageSize("top")
                    pageSize("b");
                }
