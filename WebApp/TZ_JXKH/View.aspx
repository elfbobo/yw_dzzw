<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="WebApp.TZ_JXKH.tz_jxkh.View" %>
	    ...
	    <div class="FormMenu">
		    ...
		    <div class="MenuRight">
                <%if(roleCheck.isAdmin()||roleCheck.isBm()||CurrentUser.UserGroup.Guid==document["StartDeptGuid"]){ %>
			         <a style="cursor:pointer" href="Create.aspx?guid=<%=document["guid"] %>&xmguid=<%=strProjGuid %>" ><img src="<%=Yawei.Common.AppSupport.AppPath %>/images/edit.png" style="vertical-align:text-bottom;height:13px;width:13px" />&nbsp;编辑</a>
...
<%--            <tr>
             ...
             <fieldset style="margin-top:5px">
                    <legend><span style="width:150px;font-size:13px; font-weight:bold">项目决算报告</span></legend>
                      <div id="filecontent0" style="margin-top:10px"></div>
            </fieldset>

            <fieldset style="margin-top:5px">
                    <legend><span style="width:150px;font-size:13px; font-weight:bold">项目效益报告</span></legend>
