<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListView.aspx.cs" Inherits="WebApp.Project.zjps.ListView" %>
...
<%--             <fieldset style="margin-top:5px">
                    <legend><span style="width:150px;font-size:13px; font-weight:bold">批复文件</span></legend>
                      <div id="Div1" style="margin-top:10px"></div>
            </fieldset>--%>

            <fieldset style="margin-top: 5px">
                <legend><span id="file1" style="width: 150px; font-size: 13px; font-weight: bold">评审附件</span></legend>
                <div id="filecontent1" style="margin-top: 10px"></div>
            </fieldset>
            <fieldset style="margin-top: 5px">
                <legend><span style="width: 150px; font-size: 13px; font-weight: bold">评审意见</span></legend>
                <table id="tabledy" style="width: 100%; margin-top: 5px; margin-bottom: 5px" class="table" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class='TdLabel' style="width: 70%; text-align: center">评审意见</td>
                    ...
                    <tr id="IssueRow" style="display: none">
                        <td node="zjmc" class='TdContent' style="width: 30%; text-align: left">
                             <label></label>
                        </td>
                        <td node="psyj" class='TdContent' style="width: 70%; text-align: left">
                            <label></label>
                        </td>
    ...
    <script type="text/javascript">
        ...
        $("#IssueRow").SetRowData({ data: rowsData,type:"view" });
