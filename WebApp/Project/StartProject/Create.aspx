    ...
    <form id="form1" runat="server">
        <div style="width: 100%; text-align: center">
            ...
            <div style="width:100%;text-align:left">
                <a href="<%=ConfigurationManager.AppSettings["flashurl"] %>/电子政务项目建设方案编制参考.docx"><span style="color:red;width:100%;font-size:12px">下载：项目管理建设方案模板</span></a>
            </div>
            ...
            <fieldset style="margin-top: 5px">
                <legend>
                    <span id="file_jx" style="width: 60px; height: 20px; display: block">项目绩效目标</span>
         
                </legend>
                <div id="filecontent_jx" style="margin-top: 10px"></div>
            </fieldset>
            <div style="width:100%;text-align:left">
                <a href="<%=ConfigurationManager.AppSettings["flashurl"] %>/泰州市电子政务项目建设资金绩效目标表模板.docx"><span style="color:red;width:100%;font-size:12px">下载：泰州市电子政务项目建设资金绩效目标表模板</span></a>
            </div>
