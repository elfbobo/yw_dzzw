<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SharedFormZj.aspx.cs" Inherits="WebApp.Shared.SharedFormZj" %>
    ...
    <form id="form1" runat="server">
        <div class="header">
            <div class="header-left">
                <img src="../images/shared/img-1.jpg" alt="政府投资项目监管平台" />
            </div>
            <div class="header-right">
                <div class="header-right-user"><span>欢迎，<%=Request.Params["zjmc"]??"" %></span></div>
                <div class="header-right-exit">
                    <%--<img src="../images/shared/ing-2.jpg" onclick="Exit()" width="86" style="cursor: pointer" height="47" alt="" />--%>
                </div>
            </div>
        </div>
        ...
        <div class="nav">
            <div class="nav-left">
                <div class="nav-left-t">
                    <img src="../images/wy.jpg" width="58px" alt="头像" style="border: 1px solid lightgray; border-radius: 5px; box-shadow: 0px 0px 5px #535658;" />
                </div>
                <div class="nav-left-m">
                    <div class="nav-left-m-1"><%=Request.Params["zjmc"]??"" %></div>
        ...
        <div class="content">
            ...
            <div class="right-content">
                <iframe id="iframeContent" name="Content" style="width: 100%; height: 100%; display: block; overflow-x: hidden;" frameborder="0" src="../Project/zjlogin/List.aspx?zjguid=<%=zjguid %>"></iframe>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function tab() {
        ...
        if (arguments[0] == "项目管理" || arguments[0] == "培训登记" || arguments[0] == "在线问答" || arguments[0] == "项目考核" || arguments[0] == "重大项目" || arguments[0] == "项目申报" || arguments[0] == "专家登录" || arguments[0] == "专家管理") {
            //$("#iframeContent").attr("src", $(arguments[1]).attr("url"));
