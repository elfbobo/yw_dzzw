<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjUnitSelected.aspx.cs" Inherits="Yawei.App.Shared.ProjUnitSelected" %>
...
<script type="text/javascript">
    ...
    cfg.where = "";
    cfg.condition = " ";
    cfg.ajaxUrl = "ProjUnitSelected.aspx?type=getUnit";
    cfg.width = "99%";
    cfg.height = 380;
    cfg.request = "ajax";
    ...
    function search() {
        cfg.ajaxUrl = "ProjUnitSelected.aspx?type=getUnit&unitName=" + escape($('#deptName').val());
        $("#grid").Grid(cfg);
    }
    function _confirm() {
        var guid = '',name='';
