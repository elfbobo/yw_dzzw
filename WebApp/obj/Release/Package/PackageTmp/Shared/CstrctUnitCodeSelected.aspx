<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CstrctUnitCodeSelected.aspx.cs" Inherits="Yawei.App.Shared.CstrctUnitCodeSelected" %>
    ...
    <form id="form1" runat="server">
	   ...
	   <table class="table" cellpadding="0" cellspacing="0">
           <tr>
               ...
               <td class="TdContent" style="width:20%"><input type="text" style="width:85%" id="Dept" /></td>
               <td class="TdLabel" style="width:13%">机构代码</td>
               <td class="TdContent" style="width:54%"><input type="text" style="width:35%" id="Code" /> 
...
<script type="text/javascript">
    ...
    function _confirm() {
        ...
        var id = '<%=Request["ID"]%>'; 
        if (id != '') {
            $(window.parent.document).find('#' + id.split('&')[0]).eq(0).val(rowsData[0].Code).focus();
        }
        else {
