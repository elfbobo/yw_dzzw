            ...
            <div class="FormMenu">
                ...
                <div class="MenuRight">
                    ...
                    <a style="cursor: pointer" href="javascript:showReturnPro();">
                        <img src="<%=Yawei.Common.AppSupport.AppPath %>/images/img_333.png" style="vertical-align: text-bottom; height: 13px; width: 13px" />&nbsp;退回申请</a>
                    <%} %>
...
<script type="text/javascript">
    ...
    function successPro() {
        ...
        $.ajax({
            type: 'post',
            url: 'WebFunction.ashx',
            data: { action: 'success', proguid: '<%=strGuid%>', successinfo: $("#successinfo").val(), successguid: '<%=successGuid%>', userguid: '<%=userGuid%>', depguid: '<%=depGuid%>' },
            success: function (e) {
