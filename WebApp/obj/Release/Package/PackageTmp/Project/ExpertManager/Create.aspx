<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.Project.ExpertManager.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?ProjGuid=<%=proGuid %>">列表</a> >> 编辑专家信息
                </div>
                <div class="MenuRight">
            ...
            <table style="width: 100%" class="table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="TdContent" style="width: 35%">
                         <asp:TextBox runat="server" empty="true" ID="zjmc"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="lxdh"></asp:TextBox>
                    </td>
                    <td class="TdLabel" style="width: 15%">工作单位</td>
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="gzdw"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="TdLabel" style="width: 15%">职称</td>
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="zjzc"></asp:TextBox>
                    </td>
                    <td class="TdLabel" style="width: 15%"></td>
                    <td class="TdContent">
                    </td>
