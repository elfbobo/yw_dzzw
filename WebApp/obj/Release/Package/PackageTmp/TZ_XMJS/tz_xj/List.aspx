<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMJS.tz_xj.List" %>
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "cgnr", name: "采购内容",  align: "center", render: cfg.render, drag: true },
		{ field: "htje", name: "合同金额(万元)", width: "10%", align: "center", render: cfg.render, drag: true },
        //{ field: "xjd", name: "询价单", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "zbdw", name: "中标单位", width: "20%", align: "center", render: cfg.render, order: true, drag: true }
