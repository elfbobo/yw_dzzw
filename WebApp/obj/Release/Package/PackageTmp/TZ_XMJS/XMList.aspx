<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMList.aspx.cs" Inherits="WebApp.TZ_XMJS.XMList" %>
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "Quota", name: "预算金额(万元)", width: "15%", align: "left", render: cfg.render },
        { field: "ProProperty", name: "项目属性", width: "20%", align: "left", render: cfg.render }
    ];
    ...
    function _searchData() {
        ...
        if ($("#StartDeptGuid").val() != "") {
            sql += " and StartDeptName like '%" + $("#StartDeptGuid").val() + "%'";
        }
        //联系人
        if ($("#ContactName").val() != "") {
    ...
    function ttabs(pg, titile) {
        if ($('.easyui-tabs').tabs('exists', titile)) {
            ...
            $('.easyui-tabs').tabs('add', {
                title: titile,
                content: '<iframe name="MyTabForm" src="ProjectForm.aspx?Guid=' + pg + '" frameborder="0" width="100%"  height="' + (h + 100) + '"></iframe>',
                closable: true
            });
        }
    }
