<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_zjgs.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：资金估算信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "tzgse", name: "投资估算额(万元)", align: "left", render: cfg.render, drag: true },
        { field: "zjly", name: "资金来源", width: "10%", align: "center", render: cfg.render, drag: true }
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_zjgs" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
