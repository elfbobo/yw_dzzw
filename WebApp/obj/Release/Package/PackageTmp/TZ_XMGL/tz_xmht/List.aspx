<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_xmht.List" %>
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "jf", name: "甲方", width: "10%", align: "center", render: cfg.render, drag: true },
		{ field: "yf", name: "乙方", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "htnr", name: "合同内容", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "htkssj", name: "合同开始时间", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "htjssj", name: "合同结束时间", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "htje", name: "合同金额", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_xmht" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
