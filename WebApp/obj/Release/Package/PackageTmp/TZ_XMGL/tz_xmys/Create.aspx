<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_xmys.Create" %>
        ...
        <div style="width: 100%; text-align: center">
            <div class="FormMenu">
                <div class="MenuLeft">
                    ...
                    &nbsp;&nbsp;当前位置：<a href="List.aspx?ProjGuid=<%=proGuid %>">项目验收信息</a> >> 编辑项目验收信息
                </div>
                <div class="MenuRight">
            ...
            <table style="width: 100%" class="table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="TdLabel" style="width: 15%">验收专家</td>
                    <td class='TdContent' style="width: 35%">
                        <asp:TextBox runat="server" empty="true" ID="yszj"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="TdContent">
                        <asp:TextBox runat="server" empty="true" ID="ysjg"></asp:TextBox>
                    </td>
                </tr>
