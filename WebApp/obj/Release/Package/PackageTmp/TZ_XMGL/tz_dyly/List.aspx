<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_dyly.List" %>
<!DOCTYPE html>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：单一来源信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "dylyly", name: "单一来源理由", align: "left", render: cfg.render, drag: true },
        { field: "zbrq", name: "招标日期", width: "10%", align: "center", render: cfg.render, drag: true },
		{ field: "zbdwxx", name: "中标单位信息", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "zbje", name: "中标金额(万元)", width: "10%", align: "center", render: cfg.render, order: true, drag: true },
        { field: "zjyj", name: "专家意见", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_dyly" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
