<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.TZ_XMGL.tz_zjzf.List" %>
...
<body>
	...
	<div class="FormMenu">
		<div class="MenuLeft">&nbsp;&nbsp;<img src="<%=Yawei.Common.AppSupport.AppPath %>/images/home_ico.gif" width="16px" height="13px" align="absmiddle" />&nbsp;&nbsp;当前位置：资金支付信息 </div>
		<div class="MenuRight">
...
<script type="text/javascript">
    ...
    cfg.columns = [
        ...
        { field: "zfje", name: "支付金额(万元)", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "zfsj", name: "支付时间", width: "10%", align: "center", render: cfg.render, drag: true },
        { field: "skdw", name: "收款单位", width: "10%", align: "left", render: cfg.render, drag: true }
    ];
    ...
    function deleteRow() {
        ...
        $.ajax({
            ...
            data: { action: "deleteitem", ids: ids, tablename: "tz_zjzf" },
            success: function (e) {
                //console.log("sucess");
                if (e != rowCount) {
