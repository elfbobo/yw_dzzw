...
<body>
    ...
    <div class="layui-container" style="width: 98%">
                    ...
                    <table class="layui-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <%if(roleCheck.isAdmin()||roleCheck.isBm()){ %>
                                <td><a style="cursor: pointer; color: #1E9FFF" onclick="zjjhedit('<%=dsZfjh.Tables[0].Rows[i]["guid"].ToString() %>','<%=dsZfjh.Tables[0].Rows[i]["zfje"].ToString() %>','<%=dsZfjh.Tables[0].Rows[i]["nd"].ToString() %>','<%=dsZfjh.Tables[0].Rows[i]["beizhu"].ToString() %>','<%=dsZfjh.Tables[0].Rows[i]["skdw"].ToString() %>')">编辑</a></td>
                    ...
                    <table class="layui-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <%if(roleCheck.isAdmin()||roleCheck.isBm()){ %>
                                <td><a style="cursor: pointer; color: #1E9FFF" onclick="zjzfedit('<%=dsZfqk.Tables[0].Rows[i]["guid"].ToString() %>','<%=dsZfqk.Tables[0].Rows[i]["zfje"].ToString() %>','<%=dsZfqk.Tables[0].Rows[i]["zfsj"].ToString() %>','<%=dsZfqk.Tables[0].Rows[i]["skdw"].ToString() %>','<%=dsZfqk.Tables[0].Rows[i]["beizhu"].ToString() %>')">编辑</a></td>
        ...
        <script>
            ...
            function zjzfedit(guid,zfje,zfsj,skdw,beizhu) {
                zjzfguid = guid;
            ...
            function zjjhedit(guid, zfje, nd, beizhu, skdw) {
                zjjhguid = guid;
                $("#jhzfje").val(zfje);
                $("#jhzfnd").val(nd);
                $("#jhskdw").val(skdw);
            ...
            function savezfjh() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "FundHandler.ashx",
                    data: { action: "zfjhsubmit", xmguid: '<%=strProjGuid%>', guid: zjjhguid, zfje: $("#jhzfje").val(), nd: $("#jhzfnd").val(), skdw: $("#jhskdw").val(), beizhu: $("#jhbeizhu").val() },
                    success: function (e) {
                        //console.log("sucess");
                        if (e == 1) {
                            alert("保存成功");
