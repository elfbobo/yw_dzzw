...
{
    [Table("Sys_ModelLicenses")]
    public class ModelLicenses
    {
        [Key, Column(Order = 0)]
        public string ModelGuid { set; get; }
        [Key, Column(Order = 1)]
        ...
        /// <param name="ml"></param>
        /// <returns></returns>
        public static int AddModelLies(MenusLicenses ml)
        {
        ...
        /// <param name="ml"></param>
        /// <returns></returns>
        public static int DeleteModelLies(MenusLicenses ml)
        {
